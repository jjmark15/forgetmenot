...
pub(crate) struct ViewChecklistCommandBuilder {
    subcommand_base: SubcommandBase,
    config_path: Option<PathBuf>,
}

impl ViewChecklistCommandBuilder {
    pub(crate) fn new(subcommand_base: SubcommandBase) -> Self {
        ViewChecklistCommandBuilder {
            subcommand_base,
            config_path: None,
        }
    }
...
impl SubcommandBuilder for ViewChecklistCommandBuilder {
